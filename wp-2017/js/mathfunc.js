...
function ran(form) {
   form.display.value = Math.random();}
function sqrt(form) {
    form.display.value = Math.sqrt(form.display.value);}
function sq(form) {
    form.display.value = Math.pow(form.display.value,2);}
function inver(form) {
    form.display.value = Math.pow(form.display.value,-1);}
function round(form) {
   form.display.value = Math.round(form.display.value,-1);}
function percent(form) {
   form.display.value = 0.01 * form.display.value;}
function abs(form) {
