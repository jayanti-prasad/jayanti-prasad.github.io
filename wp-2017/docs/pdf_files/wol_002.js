...
(function($) {
    ...
    $.fn.jumpList = function(){
        ...
        var containerBounds = $('.jumpList').first().parent().width();
        //Scroll bar hack. Horrible.
        var selectWidth = select.width() + 20;

        if(selectWidth <= containerBounds) {
            select.css("width", ((selectWidth < 438) ? selectWidth : 438));
        } else {
            select.css({"clear": "left", "width": containerBounds});
        }
    ...
    $.fn.socialBookmarks = function(){
        return this.each(function(){
            var shareLink = "<a href=\"http://www.addthis.com/bookmark.php?v=250&amp;username=xa-4cbc15896d9442fa\" class=\"addthis_button_compact\">Share</a>",
